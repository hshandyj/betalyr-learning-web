...
import { uploadAudio, validateFileType, getFileInfo } from "@/service/mediaService"
...
export default function UploadAudioDialog({ onUploadSuccess, children }: UploadAudioDialogProps) {
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="title">音乐名称</Label>
            <Input
              id="title"
              value={title}
